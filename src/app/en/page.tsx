  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            name: "Green Token — Cheapest AI API",
            url: "https://cngreentk.com/en",
            description:
              "One API key for 16+ AI models. 10x cheaper than OpenAI, 100% green energy powered. OpenAI-compatible API.",
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "DeepSeek-V3, DeepSeek-R1, Qwen2.5 (72B/32B/14B/7B), Qwen3-235B, Kimi-K2, GLM-5.1, Mixtral-8x22B, and more. See /v1/models for the full list.",
                },
              },
              {
                "@type": "Question",
                name: "Is it really OpenAI compatible?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. Change base_url to https://api.cngreentk.com/v1 and your existing OpenAI SDK code works without modification. We support chat completions, streaming, and function calling.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Buy a monthly plan with PayPal. You get an API key instantly. The plan resets monthly.",
                },
              },
              {
                "@type": "Question",
                name: "Where are the servers located?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Our compute runs in Northwest China, powered by wind and solar energy.",
                },
              },
              {
                "@type": "Question",
                name: "Can I use this with Claude Code?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes! We support the Anthropic Messages API. Set your base URL to https://api.cngreentk.com and use your API key as x-api-key.",
                },
              },
              {
                "@type": "Question",
                name: "What happens when I hit my quota?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Your API key returns 429 errors until the next billing cycle or until you upgrade.",
                },
              },
            ],
          }),
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        <a href="/en" className="flex items-center gap-2 text-xl font-bold tracking-tight">
      ...
      <footer className="px-6 py-12 border-t border-zinc-800 text-center text-sm text-zinc-500">
        <div className="flex flex-wrap gap-6 justify-center mb-6">
          <a href="/en" className="hover:text-zinc-300 transition">Home</a>
